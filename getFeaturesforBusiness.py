...
f = h5py.File(path_to_data+'train_image_fc8features.h5','r')
...
with open(path_to_data+"train_biz_fc8features.csv",'w') as f:  
...
with open(path_to_data+"test_biz_fc8features.csv",'w') as f:  
    df.to_csv(f, index=False)
